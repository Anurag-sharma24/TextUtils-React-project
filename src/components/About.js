...
export default function About(props) {
    ...
    let myStyle = {
        ...
        border: '1px solid',
        borderColor: props.mode==='dark'?'white':'#042742',
    ...
    return (
        <div className='container' >
            <h1 className='my-3' style={{color: props.mode==='dark'?'white':'#042742'}}>About us</h1>
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
                            TextUtils gives you a way to analyze you text quickly and efficiently. Be it word count, character count.
                        </div>
                    </div>
                </div>
